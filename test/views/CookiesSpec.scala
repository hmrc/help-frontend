...
class CookiesSpec extends GenericTestHelper {
  ...
  "Cookies section" should {
    ...
    "have a paragraph of 'Cookies are used to:' and bullets of " +
      ...
      "'remember the notifications you've seen so that you're not shown them again'" in new ViewFixture {
      ...
      getElementTextById("cookies-usages-bullets2") mustBe bullet2
    }
    ...
    "have a notice of 'GOV.UK cookies aren't used to identify you personally.' and the following text " +
      ...
      "'Find out more about how to manage cookieslink opens in a new window.'" in new ViewFixture {
  ...
  "How cookies are used section" should {
    "Google Analytics" should {
      ...
      "have a paragraph of 'Google Analytics stores information about:' and have the following bullets " +
        ...
        "'what you click on while you're visiting the site'" in new ViewFixture {
      ...
      "have a paragraph of 'We don't collect or store your personal information'" +
        ...
        "and have the following text 'Google isn't allowed to use or share our analytics data.'" in new ViewFixture {
      ...
      "have a table of 'The following cookies are used:' with the table headings 'Name', 'Purpose', 'Expires'" in new ViewFixture {
      ...
      "have the following answers in the table '_gat', 'This helps us identify how you " +
        ...
        val expectedTableAnswersText: List[String] = List("_gat",
      ...
      "have the following answers in the table 'GDS_successEvents and GDS_analyticsTokens', " +
        ...
        val expectedTableAnswersText: List[String] = List("GDS_successEvents and GDS_analyticsTokens",
      ...
      "have the following answers in the table '_ga', " +
        ...
        val expectedTableAnswersText: List[String] = List("_ga",
                                                          "This helps us identify how you use GOV.UK so we can make the site better",
                                                          "2 years")
      ...
      "have the following answers in the table 'ga_nextpage_params', " +
        ...
        val expectedTableAnswersText: List[String] = List("ga_nextpage_params",
    ...
    "Comparing different versions" should {
      ...
      "have a table of 'The following cookies are used:' and have the following headings" in new ViewFixture {
      ...
      "have the following answers in the table 'optimizelyRedirectData', " +
        ...
        val expectedTableAnswersText: List[String] = List("optimizelyRedirectData",
                                                          "This helps us identify how you use GOV.UK so we can make the site better",
                                                          "5 seconds")
    ...
    "Sessions" should {
      ...
      "have a table of 'A cookie is set to record your session activity.' " +
        "with the following headings 'Name', 'Purpose', 'Expires'" in new ViewFixture {
    ...
    "Our introductory message" should {
      ...
      "have the following paragraph 'You may see a pop-up welcome message when you first visit. " +
        ...
        "and have the following headings 'Name', 'Purpose', 'Expires'" in new ViewFixture {
      ...
      "have the following table answers in the table 'seen_cookie_message', " +
        ...
        val expectedTableAnswersText: List[String] = List("seen_cookie_message",
    ...
    "User research banner" should {
      ...
      "have the following table answers in the table 'mdtpurr', " +
        ...
        val expectedTableAnswersText: List[String] = List("mdtpurr",
                                                          "Saves a message to let us know that you no longer want to see it again.",
                                                          "1 month")
    ...
    "Our satisfaction survey" should {
      "have the following heading 'Our satisfaction survey'" in new ViewFixture {
      ...
      "have the following paragraph 'SurveyMonkeylink opens in a new window is used to collect responses to the survey." +
      ...
      "have the following table answers in the table 'SSOE', " +
        ...
        val expectedTableAnswersText: List[String] = List("SSOE",
      ...
      "have the following table answers in the table 'TS5159a2 and TSd0b041', " +
        ...
        "'When you close your browser'" in new ViewFixture {
        val expectedTableAnswersText: List[String] = List("TS5159a2 and TSd0b041",
      ...
      "have the following table answers in the table 'ep202', " +
        ...
        val expectedTableAnswersText: List[String] = List("ep202",
                                                          "This works with ep201 to help us identify how you use the survey",
                                                          "1 year")
